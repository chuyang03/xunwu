package com.cy.xunwu.web.controller.house;

import com.cy.xunwu.base.ApiResponse;
import com.cy.xunwu.base.RentValueBlock;
...
import com.cy.xunwu.web.form.MapSearch;
import com.cy.xunwu.web.form.RentSearch;
...
public class HouseController {
    ...
    /**
     * 这是一个city的接口实现，区域的接口可以仿照这个进行实现，但是目前数据库没有这个表
     * @return
     */
    //获取支持城市列表
